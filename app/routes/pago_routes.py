...
def identificacion():
    ...
    return render_template('pago/identificacion.html', direccion_cliente=direccion_cliente, dataP=dataP, dataC=dataC, dataCar=dataCar, dataU=dataU, total=total, impuesto=impuesto)
...
def entrega():
    ...
    dataC = Categoria.query.all()
    dataU = Usuario.query.all()
    dataDC = DireccionCliente.query.all()
    total = 0
    ...
    return render_template('pago/entrega.html', dataP=dataP, dataC=dataC, dataCar=dataCar, dataU=dataU, dataDC=dataDC, total=total, impuesto=impuesto)